...
if (confirmSendBtn) {
  ...
  if (job) {
    ...
    matches.forEach(printer => {
      console.log("printer.filamentRemaining", printer.filamentRemaining, "job.filamentWeight", job.filamentWeight);
    });
    const matchesFilament = matches.filter(printer => {
      return printer.filamentRemaining >= job.filamentWeight;
    });
    console.log("Matches filament:", matchesFilament);
