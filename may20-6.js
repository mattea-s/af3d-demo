  ...
  .find(el => el.getAttribute("data-w-tab")?.toLowerCase() === folderName.toLowerCase());
      ...
      selectedFiles.forEach(fileObj => {
        ...
        flagCheck.addEventListener("change", () => {
          ...
          // Remove tab and pane for this folder
          const currentTab = tabContainer.querySelector(`.file-tab[data-tab-id="${folderID}-${fileName}"]`);
          if (currentTab) {
            currentTab.remove();
            console.log("Tab removed:", currentTab);
          }
          ...
          if (paneContainer) {
            ...
            if (currentPane) {
              currentPane.remove();
              console.log("Pane removed:", currentPane);
            }
          }
