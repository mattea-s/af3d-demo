...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!printerName || printerName === "Printer Name") return;
  ...
  filamentSave.addEventListener("click", () => {
    ...
    card.querySelector(".demo-filament-remaining").textContent = `${newRemaining}g Remaining`;
    ...
    } else if (printerData.filamentRemaining <= 20 && newRemaining > 20) {
