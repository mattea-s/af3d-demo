...
function populatePrinterCard(card, job, currentIteration, quantity) {
  ...
  const spoolBlack = 360 - filamentLeft;
  const spoolGrey1 = 360 - filamentLeft;
  const spoolGrey2 = 360 - filamentRemainingConverted;
  const spoolWhite = 360 - filamentRemainingConverted;
