...
function jobToCollect(jobID, jobDiv) {
  ...
  const progressRemainingCol = progressPopupCol.querySelector(".job-progress-popup-text.lighter.remaining");
  ...
  progressRemainingCol.textContent = (job.jobProgQueued + job.jobProgProd);
