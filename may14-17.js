...
document.addEventListener("click", function (e) {
  ...
  const clickedTabPane = document.querySelectorAll(".file-info-tab");
  if (!clickedTabPane) return;
  if (clickedTabPane.classList.contains("w-tab-pane")) return;
