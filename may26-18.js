...
function populatePrinterCard(card, job, currentIteration, quantity) {
  ...
  console.log(printerData.filamentRemaining, filamentLeftOnSpool);
  const filamentGone = Math.max(0, 360 - filamentLeftOnSpool - jobFilament);
  console.log(filamentGone);

  filamentSpool.style.background = "conic-gradient(black " + filamentGone + "deg,grey " + filamentGone + "deg " + filamentLeftOnSpool + "deg,white " + filamentLeftOnSpool + "deg)";
