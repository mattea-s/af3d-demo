...
function createTagElement({ tag, category, container }) {
  ...
  // Clone and attach the edit modal
  ...
  tagEdit.addEventListener("click", (e) => {
    ...
    tagPreviewText.textContent = tagName;
    ...
    if (categoryInput) {
      ...
      if (!category && isKnownColorTag(tagName)) category = "Colour";
    ...
    colorOptions.forEach(option => {
      option.addEventListener("click", () => {
        ...
        if (selectedColor) {
          tagEl.className = "tag-name-in-list";
          tagEl.classList.add(selectedColor);
          tagPreviewEl.classList.add(selectedColor);
        }
      });
    });
