...
function initializeFileData(limit = 10) {
  const tabContainer = document.querySelector(".file-tab-container"); // adjust as needed
  const paneContainer = document.querySelector(".w-tab-content");     // adjust as needed
