...
function initializeFlaggedTab() {
  ...
  flagged.forEach(([fileName, fileData]) => {
    ...
    tab.querySelector(".material-symbols-outlined")?.addEventListener("click", (e) => {
      ...
      initializeFavoritesTab();
      console.log("initializeFavoritesTab(); called from Flagged");
      initializeAllFilesTab();
      console.log("initializeAllFilesTab(); called from Flagged");
      initializeFlaggedTab();
      console.log("initializeFlaggedTab(); called from Flagged");
