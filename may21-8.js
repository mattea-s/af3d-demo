...
function updateTabWithID(tabID, fileName) {
  ...
  console.log(tabFile);
  const tab = (tabID === tabFile) ? document.querySelector(`.file-tab[data-w-tab="${tabFile}"]`) : document.querySelector(`.file-tab[data-tab-id="${tabFile}"]`);;
  const pane = (tabID === tabFile) ? document.querySelector(`.file-info-tab[data-w-tab="${tabFile}"]`) : document.querySelector(`.file-info-tab[data-tab-id="${tabFile}"]`);
  console.log(tab);
  console.log(pane);
...
function countFilesInTabs() {
  ...
  folderTabs.forEach(tab => {
    ...
    const tabNumberVal = tabPaneWrap.children.length;
