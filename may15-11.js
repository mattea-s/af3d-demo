...
function initializeFileData(limit = 10) {
  ...
  repoEntries.forEach(([fileName, repoData], index) => {
    ...
    if (fileFlagCheck.checked === true) tabContainer.classList.add("flagged");
    console.log(fileFlagCheck.checked);
...
function initializeFavoritesTab() {
  ...
  favorites.forEach(([fileName, fileData]) => {
    ...
    if (flagCheck.checked === true) {
      ...
      tabContainer.classList.add("flagged");
      console.log(tabContainer.classList);
    }
