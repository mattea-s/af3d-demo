...
document.addEventListener("DOMContentLoaded", function () {
  ...
  moveBtn.addEventListener("click", () => {
    ...
    moveFilesModal.addEventListener("click", () => {
      console.log("Move files modal clicked");
      moveFilesModal.style.display = "none";
      const container = moveFilesModal.querySelector(".folder-list-wrap");
      const template = document.getElementById("folder-option-template1");
    ...
    moveFilesFolders.forEach(folder => {
      ...
      const folderElTemplate = document.getElementById("folder-option-template1");
