...
document.addEventListener("DOMContentLoaded", function () {
  ...
  addFolderBtn.addEventListener("click", () => {
    ...
    const folderNumber = folderTotal - 3;
    ...
    const jobTemplate = clonePane.querySelector(".file-tab.div-block-430.w-inline-block.w-tab-link");
    
    if (!jobTemplate) console.log("NO JOB FOUND");
    if (jobTemplate) {
      jobTemplate.style.display = "flex";
      console.log(jobTemplate, "visible");
    }
