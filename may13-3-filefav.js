...
function initializeFavoritesTab() {
  ...
  const favTabPane = document.querySelector('[data-w-tab="Fav"]');
  ...
  const favTabMenu = document.querySelector('[data-w-tab="Fav"] .files-tabs-wrap');
  const favTabContent = document.querySelector('[data-w-tab="Fav"] .file-info-content');

  if (favTabMenu) favTabMenu.innerHTML = '';
  if (favTabContent) favTabContent.innerHTML = '';
