...
function initializePrinterData() {
  ...
  printerCards.forEach((card, index) => {
    ...
    filamentMenuOpen.addEventListener("click", () => {
      ...
      filamentModal.addEventListener('focusout', (e) => {
        ...
        if (addCustomBtn.classList.contains("clicked")) add75Btn.classList.remove("clicked");
    ...
    addCustomBtn.addEventListener("click", () => {
      ...
      console.log("wasDisabled", wasDisabled, "mouseEventTriggered", mouseEventTriggered);
  ...
  requestAnimationFrame(() => {
    requestAnimationFrame(() => {
      if (!mouseEventTriggered) {
        ...
        console.log("Skipped focus due to mouse");
      }
    });
  });
}
      ...
      modalFilamentLevel.addEventListener("focusout", (e) => {
        // If the newly focused element is outside the modal/input
        if (!modalFilamentLevel.contains(e.relatedTarget)) {
          modalFilamentLevel.blur();
          console.log("Blurred input because user clicked outside");
        }
      });
