...
function initializeFileData(limit = 10) {
  ...
  repoEntries.forEach(([fileName, repoData], index) => {
    ...
    const fileWeightInput = tabPane.querySelector(".file-text.sidebar.filament-weight input");
    const fileTempInput = tabPane.querySelector(".file-text.sidebar.filament-weight.temp input");
