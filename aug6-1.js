...
if (!tagSearch.dataset.keyListenerAttached) {
  createTagFromSearch(tagSearch, tagListWrap, currentTagsWrap, fileBlock, jobID);
}
...
function createTagFromSearch (tagSearch, tagListWrap, currentTagsWrap, fileBlock, jobID) {
